...
public class MLP {
	...
	private static void performCalibration(Instances ninetyPercentData, Instances tenPercentData, int numRepetitions, String classifier, MultilayerPerceptron classifierObject, int folds, String size) throws Exception {
