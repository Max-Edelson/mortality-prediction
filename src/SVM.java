...
public class SVM {
	...
	private static void performCalibration(Instances ninetyPercentData, Instances tenPercentData, int numRepetitions, String classifier, LibLINEAR classifierObject, int folds, String size) throws Exception {
		...
		for (int i = 0; i < numRepetitions; i++) {
			...
			// seperate the LibLINEAR prediction scores and the labels
			...
			// LibLINEAR prediction scores and label from the first 5%
...
//			System.out.println("AUC after calibration: " + AUCAfterCalibration);
	...
	public static void runModels(int folds, String size, Instances trainingData, Instances testingData, String classifier, LibLINEAR classifierObject) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		LibLINEAR classifierObject = new LibLINEAR();
		...
		if (size.equals("sparse")) {
			classifierObject.setOptions(Utils.splitOptions("-C " + Double.toString(Math.pow(2, -5))));
