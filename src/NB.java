...
public class NB {
	...
	public static void runModels(int folds, String size, Instances trainingData, Instances testingData, String classifier, NaiveBayes classifierObject) throws Exception {
